...
def train(args,train_transforms=True,load=False):
    ...
    for epoch in range(first_epoch, args.epochs+1):
        ...
        training_ious.append(np.mean(ious))
        val_ious.append(np.mean(val_ious))
        ...
        print(val_losses,training_losses,val_ious,training_ious)
    plot(training_ious,val_ious,"Training IoU","Test IoU","IOU")
    plot(training_losses,val_losses,"Training Loss","Test Loss","Cross Entropy Loss (Weighted)")
